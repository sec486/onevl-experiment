...
OUTPUT_DIR = '/opt/onevl-experiment/output/visual_decoder_pooled16'

IMAGE_TOKEN_ID = 151655
SUBSAMPLE_FACTOR = 128  # Predict every 10th patch (2040 -> 204 targets)
...
def main():
    ...
    LAMBDA2 = 1.0  # visual decoder weight (start small)
    EPOCHS = 3
    GRAD_ACCUM = 4
    LR = 2e-5
