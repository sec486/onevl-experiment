...
"""
Variant 1: AR Answer (Baseline)
================================
Standard SFT on trajectory prediction. No latent tokens, no decoders.
OneVL equivalent: sft_distributed_qwen3vl_answer_bs64.sh

This is the weakest baseline — model directly predicts [x,y,h] from image+prompt.
"""
...
def main():
    ...
    # Train: same epochs as Stage 0 + Stage 2 combined (10 epochs total for fair comparison)
    TOTAL_EPOCHS = STAGE_0_EPOCHS + STAGE_2_EPOCHS  # 10 epochs
